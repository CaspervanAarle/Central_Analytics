...
model_name = "central_linear_20210824_115720"

CENTRAL_DIR = "C:\\Users\\Casper\\Projects\\MasterScriptie\\custom_projects\\editing\\Centralized_Learning\\results\\"

if __name__ == "__main__":
    model, X, y, config = load(CENTRAL_DIR, model_name)
    #AUC(model, X, y)
    #ROC_curve(model, X, y)
    ...
    #confidence_interval_logreg2(model, config, X, y)
